...
class Patient(models.Model):
    ...
    has_hypertension = models.CharField(verbose_name = "Hypertension", max_length=200, null=True, choices=QUESTION5, widget=forms.RadioSelect)
    has_diabetes = models.CharField(verbose_name = "Diabetes", max_length=200, null=True, choices=QUESTION5, widget=forms.RadioSelect)
    has_heart_disease = models.CharField(verbose_name = "Heart Diseases", max_length=200, null=True, choices=QUESTION5, widget=forms.RadioSelect)
    has_lung_disease = models.CharField(verbose_name = "Lung Diseases", max_length=200, null=True, choices=QUESTION5, widget=forms.RadioSelect)
    has_gastro = models.CharField(verbose_name = "Gastrointestinal Diseases", max_length=200, null=True, choices=QUESTION5, widget=forms.RadioSelect)
    has_genito = models.CharField(verbose_name = "Genitourinary Diseases", max_length=200, null=True, choices=QUESTION5, widget=forms.RadioSelect)
    has_neuro = models.CharField(verbose_name = "Neurological Diseases", max_length=200, null=True, choices=QUESTION5, widget=forms.RadioSelect)
    has_cancer = models.CharField(verbose_name = "Cancer", max_length=200, null=True, choices=QUESTION5, widget=forms.RadioSelect)
