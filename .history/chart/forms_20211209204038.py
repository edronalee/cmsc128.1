...
class PatientForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'has_hypertension': forms.ChoiceField(attrs={'class':'form-control'}),
            'has_diabetes': forms.ChoiceField(attrs={'class':'form-control'}),
            'has_heart_disease': forms.ChoiceField(attrs={'class':'form-control'}),
            'has_lung_disease': forms.ChoiceField(attrs={'class':'form-control'}),
            'has_gastro': forms.ChoiceField(attrs={'class':'form-control'}),
            'has_genito': forms.ChoiceField(attrs={'class':'form-control'}),
            'has_neuro': forms.ChoiceField(attrs={'class':'form-control'}),
            'has_cancer': forms.ChoiceField(attrs={'class':'form-control'}),
        }
