...
class PatientForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'bmiheight':forms.FloatField(attrs={'class':'form-control'}),
            'bmiweight':forms.FloatField(attrs={'class':'form-control'}),
        }
