...
from account.forms import UserPasswordResetForm, UserPasswordChangeForm
...
urlpatterns = [
    ...
    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name = "chart/password_reset_form.html", form_class=UserPasswordChangeForm), name = "password_reset_confirm"),
