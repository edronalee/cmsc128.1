...
class PatientForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'has_hypertension': forms.ChoiceField(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_diabetes': forms.ChoiceField(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_heart_disease': forms.ChoiceField(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_lung_disease': forms.ChoiceField(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_gastro': forms.ChoiceField(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_genito': forms.ChoiceField(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_neuro': forms.ChoiceField(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_cancer': forms.ChoiceField(attrs={'class':'form-control'}, widget=forms.RadioSelect),
        }
