...
class PatientForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'has_hypertension': forms.TextInput(attrs={'class':'form-control'}),
            'has_diabetes': forms.TextInput(attrs={'class':'form-control'}),
            'has_heart_disease': forms.TextInput(attrs={'class':'form-control'}),
            'has_lung_disease': forms.TextInput(attrs={'class':'form-control'}),
            'has_gastro': forms.TextInput(attrs={'class':'form-control'}),
            'has_genito': forms.TextInput(attrs={'class':'form-control'}),
            'has_neuro': forms.TextInput(attrs={'class':'form-control'}),
            'has_cancer': forms.TextInput(attrs={'class':'form-control'}),
        }
