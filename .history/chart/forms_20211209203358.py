...
class PatientForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'has_diabetes': forms.TextInput(),
            'has_heart_disease': forms.TextInput(),
            'has_lung_disease': forms.TextInput(),
            'has_gastro': forms.TextInput(),
            'has_genito': forms.TextInput(),
            'has_neuro': forms.TextInput(),
            'has_cancer': forms.TextInput(),
        }
