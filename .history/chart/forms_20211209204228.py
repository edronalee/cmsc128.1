...
class PatientForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'has_hypertension': forms.RadioSelect(attrs={'class':'form-control'}),
            'has_diabetes': forms.RadioSelect(attrs={'class':'form-control'}),
            'has_heart_disease': forms.RadioSelect(attrs={'class':'form-control'}),
            'has_lung_disease': forms.RadioSelect(attrs={'class':'form-control'}),
            'has_gastro': forms.RadioSelect(attrs={'class':'form-control'}),
            'has_genito': forms.RadioSelect(attrs={'class':'form-control'}),
            'has_neuro': forms.RadioSelect(attrs={'class':'form-control'}),
            'has_cancer': forms.RadioSelect(attrs={'class':'form-control'}),
        }
