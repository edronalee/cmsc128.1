...
class Patient(models.Model):
    ...
    has_hypertension = models.CharField(verbose_name = "Hypertension", max_length=200, null=True, choices=QUESTION5)
    has_diabetes = models.CharField(verbose_name = "Diabetes", max_length=200, null=True, choices=QUESTION5)
    has_heart_disease = models.CharField(verbose_name = "Heart Disease", max_length=200, null=True, choices=QUESTION5)
    has_lung_disease = models.CharField(verbose_name = "Lung Disease", max_length=200, null=True, choices=QUESTION5)
    has_gastro = models.CharField(verbose_name = "Gastrointestinal Complications", max_length=200, null=True, choices=QUESTION5)
    has_genito = models.CharField(verbose_name = "Genitourinary Complications", max_length=200, null=True, choices=QUESTION5)
