...
class Patient(models.Model):
    ...
    antigenfile = models.FileField(verbose_name= "antigenfile", null = True, upload_to = "pdf_uploads/")
    #antigenfile
    rtpcrresult = models.CharField(max_length=200, null=True, choices=RTPCRRESULT)
    rtpcrdate = models.DateField(null=True)
    rtpcrfile = models.FileField(verbose_name= "rtpcrfile", null = True, upload_to = "pdf_uploads/")
    #rtpcrfile
    xray = models.CharField(max_length=200, null=True, choices=XRAY)
    xraydate = models.DateField(null=True)
    xrayfile = models.FileField(verbose_name= "xrayfile", null = True, upload_to = "pdf_uploads/")
    #xrayfile
