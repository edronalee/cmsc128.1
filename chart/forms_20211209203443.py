...
class PatientForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'has_hypertension': forms.TextInput(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_diabetes': forms.TextInput(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_heart_disease': forms.TextInput(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_lung_disease': forms.TextInput(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_gastro': forms.TextInput(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_genito': forms.TextInput(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_neuro': forms.TextInput(attrs={'class':'form-control'}, widget=forms.RadioSelect),
            'has_cancer': forms.TextInput(attrs={'class':'form-control'}, widget=forms.RadioSelect),
        }
