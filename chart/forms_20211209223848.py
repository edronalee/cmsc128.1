...
class PatientForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'has_hypertension': forms.RadioSelect(empty_label=None),
            'has_diabetes': forms.RadioSelect(empty_label=None),
            'has_heart_disease': forms.RadioSelect(empty_label=None),
            'has_lung_disease': forms.RadioSelect(empty_label=None),
            'has_gastro': forms.RadioSelect(empty_label=None),
            'has_genito': forms.RadioSelect(empty_label=None),
