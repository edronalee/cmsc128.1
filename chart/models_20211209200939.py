...
class Vitalsign(models.Model):
    ...
    syspressure = models.IntegerField(max_length=200, null=True)
    diaspressure = models.IntegerField(max_length=200, null=True)
    heartrate = models.IntegerField(max_length=200, null=True)
    respiratoryrate = models.IntegerField(max_length=200, null=True)
    temperature = models.FloatField(max_length=200, null=True)
    painscale = models.IntegerField(max_length=200, null=True)
    o2saturation = models.FloatField(max_length=200, null=True)
    date_created = models.DateTimeField(auto_now_add=True, null=True)
    others = models.CharField(verbose_name = "Other Remarks", max_length=200, null=True)
